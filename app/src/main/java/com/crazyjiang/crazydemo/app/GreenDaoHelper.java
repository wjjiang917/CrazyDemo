...
import com.crazyjiang.crazydemo.app.greendao.DaoMaster;
import com.crazyjiang.crazydemo.app.greendao.DaoSession;
...
public class GreenDaoHelper {
    ...
    public static void initDatabase(Application application) {
        ...
        mHelper = new DaoMaster.DevOpenHelper(application, Constant.DB_NAME, null);
